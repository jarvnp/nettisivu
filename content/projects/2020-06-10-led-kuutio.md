...
description: <video class = "ledkuutio" loop muted playsinline controls><source
  src="/img/ledkuutio.webm" type="video/webm" alt="Video LED-kuution toiminnasta"><source src="/img/ledkuutio.mp4"
...
singlePageContent: >-
  ...
  width="400px" alt="LED-kuutio">Tästä projektista on aika vaikea kirjoittaa mitään, koska
  ...
  src="/img/Led-kuutio-inside1-small.jpg" width="400px" alt="LED-kuutio sisältäpäin. Johtoja ja elektroniikkaa">
